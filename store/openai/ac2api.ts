...
const vendor: VendorConfig = {
  ...
  models: [
    ...
    { name: "gemini-3-flash", type: "text", modelName: "gemini-3-flash", think: true },
    { name: "gemini-3.1-pro-high", type: "text", modelName: "gemini-3.1-pro-high", think: true },
    { name: "claude-haiku-4-5", type: "text", modelName: "claude-haiku-4-5", think: true },
    ...
    { name: "claude-opus-4-5", type: "text", modelName: "claude-opus-4-5", think: true },
    { name: "gpt-5.4", type: "text", modelName: "gpt-5.4", think: true },
    { name: "grok-3", type: "text", modelName: "grok-3", think: true },
    { name: "grok-4", type: "text", modelName: "grok-4", think: true },
  ],
};
...
const updateVendor = async (): Promise<string> => {
  try {
    const remoteVendorUrl = "https://tf.kaipai.vip/store/openai/aiclient2api.ts";
